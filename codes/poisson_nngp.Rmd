...
ci_parms <- confint2(c(exp(fitted_parms$par[1:2]), fitted_parms$par[3:4]), sigma_hat) |>
  dplyr::mutate(
    par = c("sigma", "l", "b0", "b1"),
...
cowplot::save_plot(filename = "./images/predicted.png", plot = p)
cowplot::save_plot(filename = "./images/residuals.png", plot = p3)
```

```{r echo = F, fig.height = 4}
knitr::include_graphics("../images/predicted.png")
```
