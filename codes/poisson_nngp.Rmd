...
Generalized Gaussian Process (GGP) are latent Gaussian Process (GP) with a response variable belonging to exponential family. Meanwhile, Nearest Neighbour Gaussian Process is an alternative for GPs which can be infeasible for large number of locations. 

In this report we illustrate the estimation procedure of the combined methods in the context of spatial data through a simulation study for a small data showing each step of the procedure and then the results of estimation for a more realistic dataset.
...
# Inference of latent Gaussian Process
...
## NNGP: Neighbourhood of each location
...
## Laplace approximation of full posterior of latent field
...
## Function to joint estimate the parameters and latent field
